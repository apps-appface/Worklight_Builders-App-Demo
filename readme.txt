...
2.Install IBM Worklight(IBM MobileFirst) plugin in Eclipse
 ...
 -Create REAL ESTATE Database and import real_estate.sql file to that database.
 
3.Import project in your workspace
 
4.Right click project_name/apps/app/BuildersAdmin , project_name/apps/app/Employee , project_name/apps/app/SalesDashBoard and select run on IBM MobileFirst Development Server.
